...
!@CoreTAAS
config t
 hostname CoreTAAS-31-(PLDT)
 Track 1 Int gi 0/1 line-protocol
 int vlan 1
  standby 1 ip 10.31.1.16
  standby 1 preempt
...
ifname ens256 \
ipv4.method manual \
ipv4.addresses 10.31.1.6/24 \
autoconnect yes

nmcli connection up BRIDGED

route add 10.0.0.0/8 via 10.31.1.4
route add 200.0.0.0/24 via 10.31.1.4
~~~
...
~~~
!@NetOps
ifconfig ens256 10.31.1.6 netmask 255.255.255.0 up
route add 10.0.0.0/8 via 10.31.1.4
route add 200.0.0.0/24 via 10.31.1.4
~~~
...
~~~
[realdevices]
ctaas ansible_host=10.31.1.2 ansible_user=admin ansible_password=pass
cbaba ansible_host=10.31.1.4 ansible_user=rivan ansible_password=C1sc0123
...
~~~
[real_cisco]
CTAAS ansible_host=10.31.1.2
CBABA ansible_host=10.31.1.4
CUCM ansible_host=10.31.100.8
EDGE ansible_host=10.31.31.1
